...
9. 正文 200-800字
10. 段落短（40-90字），适合微信公众号
11. 允许使用"这次更新""这组近照""状态""气质""风格"这类安全表达
12. 文章要像"爱豆状态观察"，不是饭圈尖叫文
13. 结尾要有余味，不要硬互动
14. 韩国人名统一用中文译名（如"宋智孝""苏志燮"），团体名可用国际通用名
...
2. **字数**: 200-800字（含标点）
3. **文风**: 爱豆状态观察 - 审美观察写法，多写状态、气质、风格变化
4. **段落**: 短段落，每段40-90字，超过120字自动拆分
